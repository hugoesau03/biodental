...
CREATE TABLE IF NOT EXISTS `canjes_recompensas` (
  ...
  `servicio_id` int DEFAULT NULL COMMENT 'Cuando tipo = servicio: el tratamiento canjeado, para aplicarlo en la siguiente cita del paciente',
  `item_nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Copia del nombre al momento del canje, por si el producto/servicio cambia o se elimina después',
...
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  `notas` text COLLATE utf8mb4_unicode_ci,
  `padecimientos` text COLLATE utf8mb4_unicode_ci COMMENT 'Padecimientos actuales y antecedentes médicos',
  `medicamentos` text COLLATE utf8mb4_unicode_ci COMMENT 'Medicamentos actuales del paciente',
  `motivo_consulta` text COLLATE utf8mb4_unicode_ci COMMENT 'Motivo principal de la consulta inicial',
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `es_superadmin` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Operador de la plataforma: puede crear consultorios (tenants) nuevos, independiente del rol admin/doctor/recepcionista/asistente',
